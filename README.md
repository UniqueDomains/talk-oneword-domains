# Available .TALK One-Word Domains (5,622,042)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-7%2C585%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-5%2C622%2C042%20domains-6f42c1">
...
> **Important:** this repository is a **public 7,585-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,622,042 domains** on the canonical page below.

**Public extract:** 7,585 rows · **Live catalog:** 5,622,042 domains
...
<p align="center">
  ...
  <a href="https://unique.domains/domains/tld/talk?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_talk_oneword_domains&utm_content=top_create_radar"><b>🔔 Create Radar</b></a> ·
  <a href="https://unique.domains/domains/tld/talk?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_talk_oneword_domains&utm_content=top_start_project"><b>🚀 Start a Project</b></a> ·
  <b>⬇️ Download sample</b>: <a href="./talk.csv">CSV</a> / <a href="./talk.json">JSON</a>
</p>

<p align="center">
  <a href="https://unique.domains/technology?utm_source=github&utm_medium=referral&utm_campaign=repo_talk_oneword_domains&utm_content=top_methodology">Methodology</a> ·
  <a href="https://unique.domains/api?utm_source=github&utm_medium=referral&utm_campaign=repo_talk_oneword_domains&utm_content=top_api_docs">API docs</a>
</p>
...
- **Investors:** [Create a Radar from this exact .TALK search](https://unique.domains/domains/tld/talk?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_talk_oneword_domains&utm_content=top_create_radar)
- **Founders:** [Start a Project from this exact .TALK search](https://unique.domains/domains/tld/talk?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_talk_oneword_domains&utm_content=top_start_project)
- **Researchers / builders:** [Download CSV](./talk.csv) or [Download JSON](./talk.json)
...
| ----------------------- | ------------------------------------------------ |
| 7,585-row public sample | 5,622,042 live domains                           |
...
| brave.talk      | resell    | —         | —             | 76             | 48     | 5      | Spaceship, Inc. |
...
| goon.talk       | available | $46.98    | —             | 80             | 36     | 5      | namecheap       |
| talk.talk       | resell    | —         | —             | 110            | 36     | 4      | Dynadot, LLC    |
| live.talk       | premium   | $1,250    | $1,250        | 108            | 55     | 4      | name.com        |
...
| ethereal.talk   | available | $46.98    | —             | 88             | 32     | 8      | namecheap       |
...
> Unique Domains. *Available .TALK One-Word Domains*. Version 2026-04-09. Public GitHub extract for the exact Unique Domains search represented by this repository.
